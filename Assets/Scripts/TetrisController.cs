...
public class TetrisController : MonoBehaviour
{
    ...
    public void RotateClockwise()
    {
        ...
        Dictionary<int, List<Vector2Int>> SRS_TestPositions = new Dictionary<int, List<Vector2Int>>();
        if (tetris.shape == TetrisShape.I)  SRS_TestPositions = SRS.instance.I_TestSequences;
        else SRS_TestPositions = SRS.instance.O_TestSequences;

        foreach (Vector2Int offset in SRS_TestPositions[tetris.rotationIndex])
        {
